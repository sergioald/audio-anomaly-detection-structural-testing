...
def main() -> None:
    ...
    parser.add_argument(
        "--model", type=Path, default=Path("models/pretrained_cae_wst_latent24_structural_audio.h5")
    )
    ...
    refs = average_reference_maps(
        model, normal_train, layer_name=layer_name, map_ids=args.map_ids, batch_size=16
    )
