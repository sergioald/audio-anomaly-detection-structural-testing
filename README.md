...
## Example result from the pre-trained model
...
<p align="center">
  <em>Real test-set NCC scores generated by the pre-trained CAE workflow. Each point is one test sample represented by the two selected feature-map NCC scores used by the downstream classifier.</em>
</p>
